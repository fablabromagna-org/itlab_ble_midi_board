/**
 * ITLab BLE MIDI Board Client
 * Copyright (C) 2021 Ivan Tarozzi (itarozzi@gmail.com) 
 * 
 ...
 * Description:
 * ------------
 * This is the first attempt to control my NUX MIGHTY PLUG.
 * It connects to the first MIDI BLE device found, and send 
 * MIDI CC 49 every 5 seconds, changing NUX preset channel
 * 
 * -----------------------------------------------------------------
 * 
 ...
 *
 * Credits:
 * derived from ESP32 client example from ESP32 Arduino project,  updated by chegewara
 * 
 */
